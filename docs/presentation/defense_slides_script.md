...
| Сервис | Совместное пространство | Идеи и обсуждения | Маршрут по дням | Расходы и баланс | Погода | AI-подсказки | Приглашения |
|---|---|---|---|---|---|---|---|
...
Пояснение к оценке:
- `Частично` — функция есть, но не в полном совместном контуре (закрыт только фрагмент сценария).
